...
module MonisApp.Object.Transactions_aggregate_fields exposing (..)
...
avg :
    SelectionSet decodesTo MonisApp.Object.Transactions_avg_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
avg object____ =
    Object.selectionForCompositeField "avg" [] object____ (Basics.identity >> Decode.nullable)


type alias CountOptionalArguments =
    { columns : OptionalArgument (List MonisApp.Enum.Transactions_select_column.Transactions_select_column)
...
count :
    ...
    -> SelectionSet Int MonisApp.Object.Transactions_aggregate_fields
count fillInOptionals____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "columns" filledInOptionals____.columns (Encode.enum MonisApp.Enum.Transactions_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals____.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo MonisApp.Object.Transactions_max_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
max object____ =
...
min :
    SelectionSet decodesTo MonisApp.Object.Transactions_min_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
min object____ =
...
stddev :
    SelectionSet decodesTo MonisApp.Object.Transactions_stddev_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
stddev object____ =
...
stddev_pop :
    SelectionSet decodesTo MonisApp.Object.Transactions_stddev_pop_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
...
stddev_samp :
    SelectionSet decodesTo MonisApp.Object.Transactions_stddev_samp_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
...
sum :
    SelectionSet decodesTo MonisApp.Object.Transactions_sum_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
sum object____ =
...
var_pop :
    SelectionSet decodesTo MonisApp.Object.Transactions_var_pop_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
var_pop object____ =
...
var_samp :
    SelectionSet decodesTo MonisApp.Object.Transactions_var_samp_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
var_samp object____ =
...
variance :
    SelectionSet decodesTo MonisApp.Object.Transactions_variance_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Transactions_aggregate_fields
variance object____ =
