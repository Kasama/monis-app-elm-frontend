...
module MonisApp.Object.Accounts_aggregate_fields exposing (..)
...
type alias CountOptionalArguments =
    { columns : OptionalArgument (List MonisApp.Enum.Accounts_select_column.Accounts_select_column)
...
count :
    ...
    -> SelectionSet Int MonisApp.Object.Accounts_aggregate_fields
count fillInOptionals____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "columns" filledInOptionals____.columns (Encode.enum MonisApp.Enum.Accounts_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals____.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo MonisApp.Object.Accounts_max_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Accounts_aggregate_fields
max object____ =
    Object.selectionForCompositeField "max" [] object____ (Basics.identity >> Decode.nullable)


min :
    SelectionSet decodesTo MonisApp.Object.Accounts_min_fields
    -> SelectionSet (Maybe decodesTo) MonisApp.Object.Accounts_aggregate_fields
min object____ =
