...
module MonisApp.Enum.Transactions_select_column exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Transactions_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Transactions_select_column -> String
toString enum____ =
    case enum____ of
        Account_id ->
            "account_id"
...
-}
fromString : String -> Maybe Transactions_select_column
